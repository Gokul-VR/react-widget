...
import { TimePicker } from '../elements/time-picker';
...
const handleConfirm = (time: {
  ...
  alert(
    `Time selected: ${time.hours}:${time.minutes.toString().padStart(2, '0')} ${time.period}`,
  );
};
    ...
    <>
      <div className='flex flex-row gap-2 '>
        ...
        <div className='flex flex-col -ml-[0.9rem] gap-[0.7rem]'>
          ...
          >
            Pick the serving time for your event.
          </h1>
        </div>
      </div>
      <div className=' flex items-center justify-center mb-[1.68rem]'>
        <TimePicker
